      ...
      <section className="relative h-screen flex items-center justify-center bg-gradient-to-b from-gray-900 to-slate-800 text-white overflow-hidden">
        ...
        >
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4">
            ...
            <span className="block text-teal-400">Ahmed Adb Elmohsen</span>
          </h1>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1">
              <h3 className="text-2xl font-bold mb-4">I'm <span className="text-teal-600">Ahmed Adb Elmohsen</span>, a Software Engineer</h3>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-teal-600">ahmed.adb.elmohsen@gmail.com</p>
                  </div>
                </div>
