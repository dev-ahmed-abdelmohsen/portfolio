      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-xl font-bold mb-4">Ahmed Adb Elmohsen</h3>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a 
                href="https://github.com/ahmedadb" 
                target="_blank" 
              ...
              <a 
                href="https://linkedin.com/in/ahmedadb" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition"
              ...
              <a 
                href="https://twitter.com/ahmedadb" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition"
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {currentYear} Ahmed Adb Elmohsen. All rights reserved.
          </p>
